        ...
        <div class="schedule-list">
            ...
            <div class="schedule-item">
                ...
                <div class="schedule-details">
                    ...
                    <div class="schedule-location"><i class="fa-solid fa-location-dot"></i> Ruang Kelas A, Gedung TI
                    </div>
            ...
            <div class="schedule-item">
                ...
                <div class="schedule-details">
                    ...
                    <div class="schedule-location"><i class="fa-solid fa-location-dot"></i> Lab Jaringan, Gedung TI
                    </div>
            ...
            <div class="schedule-item">
                ...
                <div class="schedule-details">
                    ...
                    <div class="schedule-location"><i class="fa-solid fa-location-dot"></i> Ruang Kelas B, Gedung TI
                    </div>
            ...
            <div class="schedule-item">
                ...
                <div class="schedule-details">
                    ...
                    <div class="schedule-location"><i class="fa-solid fa-location-dot"></i> Ruang Ujian 1, Gedung TI
                    </div>
            ...
            <div class="schedule-item">
                ...
                <div class="schedule-details">
                    ...
                    <div class="schedule-location"><i class="fa-solid fa-location-dot"></i> Auditorium, Gedung Utama
                    </div>
    ...
    <script>
        ...
        const animateOnScroll = () => {
            ...
            const elements = document.querySelectorAll(
                '.filter-section, .calendar-container, .schedule-list, .schedule-item');
        ...
        document.querySelectorAll('.filter-section, .calendar-container, .schedule-list, .schedule-item').forEach(
        element => {
