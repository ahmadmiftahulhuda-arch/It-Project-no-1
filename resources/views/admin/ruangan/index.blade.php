...
<head>
    ...
    <style>
        ...
        /* ============================
           ...
           SAMA PERSIS SEPERTI DI HALAMAN PEMINJAMAN
           ============================ */
        ...
        /* Dark mode untuk notification elements */
    ...
    <div class="main-content">
        ...
        <div class="header">
            <form id="searchForm" method="GET" action="{{ route('admin.ruangan.index') }}" class="search-bar">
                ...
                <input type="text" name="cari" placeholder="Cari ruangan..."
                    value="{{ request('cari') }}">
                <button type="submit" style="display: none;"></button>
            </form>

            <div class="user-actions">
                <!-- Improved Notification Dropdown - SAMA SEPERTI DI PEMINJAMAN -->
                <div class="dropdown">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                let searchTimeout;
                document.querySelectorAll('.search-bar input[name="cari"]').forEach(input => {
                ...
                const kapasitasFilter = document.getElementById('kapasitas_filter');
                if (kapasitasFilter) {
                    kapasitasFilter.addEventListener('change', () => document.getElementById('filterForm').submit());
                }
