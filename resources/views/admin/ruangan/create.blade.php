...
<head>
    ...
    <title>Tambah Ruangan - Sistem Manajemen Peminjaman</title>
    ...
    <div class="main-content">
        ...
        <div class="page-title">
            <div>
                ...
                <p>Tambahkan informasi ruangan baru ke dalam sistem</p>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="kode_ruangan" name="kode_ruangan" class="form-control @error('kode_ruangan') is-invalid @enderror" 
                                   value="{{ old('kode_ruangan') }}" required placeholder="Masukkan kode ruangan">
                            @error('kode_ruangan')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="kapasitas" name="kapasitas" class="form-control @error('kapasitas') is-invalid @enderror" 
                                   value="{{ old('kapasitas') }}" min="1" required placeholder="Jumlah orang">
                            @error('kapasitas')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
