...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="/admin/slotwaktu" class="menu-item active"><i class="fas fa-clock"></i> <span>Slot Waktu</span></a>
    ...
    <div class="main-content">
        ...
        <div class="page-title">
            <div>
                ...
                <p>Tambahkan slot waktu baru untuk jadwal peminjaman</p>
            </div>
            ...
            <form action="{{ route('admin.slotwaktu.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="id_slot" name="id_slot" class="form-control @error('id_slot') is-invalid @enderror"
                                   value="{{ old('id_slot') }}" required placeholder="Masukkan ID Slot">
                            @error('id_slot')
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Simpan Slot Waktu
                    </button>
                </div>
            </form>
        </div>
